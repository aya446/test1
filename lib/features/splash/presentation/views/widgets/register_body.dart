                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text('Create new account ', style: Styles.White20),
                            const SizedBox(height: 40),

                            Align(
                              alignment: Alignment.center,
                              child: ImagePickerWidget(
                                imageFile: userModel.pickedImage,
                                onPick: () async {
                                  await userModel.pickImage();
                                  setState(() {});
                                },
                              ),
                            ),
                            ...
                            PhoneInputField(
                              controller: userModel.phoneController,
